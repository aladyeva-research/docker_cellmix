...
RUN R -e "install.packages(c('parallel', 'gtools', 'pdist', 'enrichR', 'pheatmap', 'limSolve', 'corpcor', 'beeswarm', 'bibtex', 'nFactors', 'cowplot', 'matrixStats', 'combinat'), dependencies = T)"
...
RUN R -e "BiocManager::install(pkgs = c('GSEABase','genefilter','preprocessCore'), dependencies = T)"
